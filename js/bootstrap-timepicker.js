...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (parent.hasClass('input-append') || parent.hasClass('input-prepend') || parent.hasClass('input-group')) {
        parent.find(parent.hasClass('input-group') ? '.input-group-addon' : '.add-on').on({
